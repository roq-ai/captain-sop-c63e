...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'sop-writing-expert'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Experts', path: '/experts', entity: 'expert', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Sops', path: '/sops', entity: 'sop', service: AccessServiceEnum.PROJECT, icon: FiFileText },
