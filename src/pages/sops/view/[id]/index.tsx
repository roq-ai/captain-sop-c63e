...
import { getSopById } from 'apiSdk/sops';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('sop', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/sops/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Questions" text={data?.questions} />

                <FormListItem label="Ai Generated Sop" text={data?.ai_generated_sop} />

                <FormListItem label="Uploaded Sop" text={data?.uploaded_sop} />

                <FormListItem label="Sop Score" text={data?.sop_score} />
