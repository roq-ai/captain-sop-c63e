...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Captain SOP`}</title>

        <meta
          name="description"
          content="Welcome to Captain SOP - Simplifying your study visa process with AI-generated statements of purpose. Upload, score, or hire expert help - all in one place."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjkxOTUwNzM1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Captain SOP - Simplifying your study visa process with AI-generated statements of purpose. Upload, score, or hire expert help - all in one place.`}
            </Text>
            <Box
